...
# ╔═╡ cb04cbcf-20c9-4584-b981-f689cb3608e4
pwd()

# ╔═╡ 2c03e08e-1c1c-449a-b129-85584c2f20bd
case_path = "../data/LV20_26bus_Fr_Copy"

# ╔═╡ c4498696-ff7d-4660-9e82-8debff9744ed
cd(case_path)
...
# ╔═╡ 748c4928-6334-4c77-80be-edad6c605db2
ODSS.dss(
	"""
	clear
	compile $file
...
md"""
This can be helpful, as some networks may not be as large as you think, e.g., the [IEEE PES test feeder 2015 European LV test system](https://cmte.ieee.org/pes-testfeeders/wp-content/uploads/sites/167/2017/08/European_LV_Test_Feeder_v2.zip), [lvtestcase](https://github.com/sanderclaeys/DistributionTestCases.jl/blob/master/src/data/lvtestcase/lvtestcase_pmd_template.dss). Relavant points are also discussed in [paper](https://www.sciencedirect.com/science/article/pii/S0378779624005327).
Applying this approach helps reduce the network size and computation time.
"""
...
md"""
## 2.4 OPF Problem Solving
"""

# ╔═╡ 5376c602-d090-4395-b68a-eface06d9684
md"""
### MATHEMATICAL Model
We convert the ENGINEERING model (SI/engineering units) to the MATHEMATICAL model (pu values), which is then used to generate the JuMP model that is actually optimised.
"""
...
# ╔═╡ 3fe6b6dd-16e2-4082-98da-2b70b9ef73c1
...
manifest_format = "2.0"
project_hash = "7191d8775e39d218effd183cd3bd6dc53093541a"
