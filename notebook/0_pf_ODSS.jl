...
# ╔═╡ 728ad479-80bd-4f48-be2f-cc44245be7f5
begin
	using DataFrames
	using CSV
	# using Plots
...
# ╔═╡ 7f3c549f-93a2-41a5-b22d-dba660aa9118
const ODSS = OpenDSSDirect

# ╔═╡ 6ddde588-3f57-4161-a2ce-da07bb54f6f3
md"""
## 0.2 Run a Power Flow
"""

# ╔═╡ f6f4fff4-2137-4bd2-9500-72fca4a506a0
md"""
### Load Network Data
A three-phase, four-wire, 26-bus low-voltage distribution network is used here as an example.
"""
...
# ╔═╡ a87b170f-5754-43c6-bccd-f85c096ad4b3
begin
...
# ╔═╡ 633c80bc-b609-44db-adad-41e4c88dfe58
md"""
### Solve the circuit
"""

# ╔═╡ 113ab2b1-877d-47d5-8eea-3f6e213240a9
md"""
The `dss` function is used for passing commands to OpenDSS.
"""

# ╔═╡ aeebd317-0286-427b-a6e1-331f193a6776
ODSS.dss("""
		 clear
		 compile $file
		 solve
...
# ╔═╡ 711cbcd4-92b3-4c45-a834-cf0936482012
md"""
...
# ╔═╡ da625c48-b364-4772-8d6c-b3beca06102b
ODSS.dss("summary")
...
# ╔═╡ 5e073edd-39a6-4218-b381-e6180b5f985a
md"""
We can easily find the bus name and the corresponding distance.
"""

# ╔═╡ ea5bf846-24a9-4586-afb0-525c3b1b85ce
busdistancesdf[busdistancesdf.Bus .== "b1699", :busdistances]

# ╔═╡ 72bbf49a-21bf-4fa7-bc46-d49b0e66b49f
...
# ╔═╡ 5967ef5e-e4fa-412a-b273-6a0baaf02c0f
ODSS.dss("""
		 export voltages
		 """)

# ╔═╡ b2519938-0994-4d88-b474-0664722bbddb
voltages_file = "E:\\lvdata\\LV20_26bus_Fr_Copy_2\\lv20_26bus_EXP_VOLTAGES.csv"

# ╔═╡ a8b65c29-774a-4d7a-9d7b-23784a99e402
md"""
Construct DataFrame for the voltage results:
"""

# ╔═╡ 3b3d310f-2b0c-441f-a7bd-2127c0e15dda
begin
...
# ╔═╡ 67642486-5209-420f-84b2-c8888df290dc
md"""
Add the distance elements:
"""

# ╔═╡ c819b494-f958-44c2-a71c-7d86dcff63ba
begin
...
# ╔═╡ 5e246819-64d9-4d4e-b156-5858edf9c157
md"""
### plot voltage profiles wrt bus distances
"""

# ╔═╡ a6ae5490-f8a0-4949-a5ca-e66cc15ce2e9
begin
...
# ╔═╡ d884fc50-6da9-4f8e-9329-9b5de490dd38
begin
...
manifest_format = "2.0"
project_hash = "499f6b0b53d73f4469b0ad5bbbbd22d06f315a15"
