...
PlutoUI.LocalResource("../data/resources/extension_summary.svg", "width"=>"700px")
...
data_eng = PMD.parse_file(
	...
	"../data/resources/lvtestcase_notrans.dss",
...
# ╔═╡ a668657b-d6e0-43e4-9864-a1528acb1fd3
begin
...
# ╔═╡ ef69f460-e853-4b39-98ad-2e6464b0c213
begin
	vm_pu_lk = fill(NaN, length(data_eng["load"]), length(K))
	for k in K, l in 1:length(data_eng["load"])
		bus_id = data_eng["load"]["load$l"]["bus"]
		bus_ind = data_math_mn["bus_lookup"]["$k"][bus_id]
		sol_bus = sol_eng["nw"]["$k"]["bus"][bus_id]
		data_bus = data_eng["bus"][bus_id]
		vbase = data_math_mn["nw"]["$k"]["bus"]["$bus_ind"]["vbase"]
		phase = data_eng["load"]["load$l"]["connections"][1]
...
# ╔═╡ 62cc54b0-32b5-43ab-a0f3-8d7c45cffb84
data_math_mn
...
# ╔═╡ 1c03c46e-b846-4305-9619-61b4dc6f11e3
vm_pu_lk
...
manifest_format = "2.0"
project_hash = "567bb1630d04f3766cce8da2be1c733cfbba3e90"
