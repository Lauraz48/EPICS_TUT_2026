1) increase voltage drop by increasing the load, you can also do more load unbalance to show more neutral voltage rise (target ate least 5% voltage drop throughout)
2) just use the default IVRENPowerModel
