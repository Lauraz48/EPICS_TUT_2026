...
md"""
Have a look at the dss files in VSCode (extension OpenDSS for better inspection).
...
begin
	scatter(voltages_df_1.busdistances, voltages_df_1[!,Symbol(" Magnitude4")], label="phase n")
	xlabel!("Distance from distribution transformer (km)")
	ylabel!("Vpn (V)")
	ylims!(0, 20)
end
...
# ╔═╡ 9ac3fa67-b00b-4cb4-9ff8-c64f25b0f087


# ╔═╡ 5d82e9b2-bcd5-4c5f-aec3-692b965666af
...
# ╔═╡ 98c7438e-466d-4c0e-aa5e-c44f7d8b8d92
...
manifest_format = "2.0"
project_hash = "55e9833f1653bd9a5bd6e8eda039aa64f36b6457"
